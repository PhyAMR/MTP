...
\end{DispWithArrows}
\begin{DispWithArrows}[displaystyle, format=c]
  \\varphi_{1}\left(\frac{k}{n}\right)=\int e^{i \frac{k}{n} x} q(x) d x=1+\frac{i k}{n}\\langle x\rangle+\mathcal{O}\left(\frac{1}{n^2}\right) \text { as } n \rightarrow \infty
\end{DispWithArrows}
...
\begin{DispWithArrows}[displaystyle, format=c]
  p(x)=\frac{1}{\sqrt{2 \pi}} e^{-\frac{x^{2}}{2}} \equiv N(0,1)
